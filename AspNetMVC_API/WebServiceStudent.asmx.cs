    ...
    public class WebServiceStudent : System.Web.Services.WebService
    {
        ...
        public string Insert(string name,string surname)
        {
            try
            {
                ...
                if (insertResult>0)
                {
                    ...
                    // return "Kayıt başarılı olarak eklendı. id=" + newStudent.Id;
        ...
        public string Delete (int id)
        {
            try
            {
                if (id>0)
                {
                    ...
                    {
                        throw new Exception("Beklenmedik bir hata oluştuğundan kayıt silinemedi.");
                    }
                }
                else
                {
        ...
        public string Update (int currentid, string newname, string newsurname)
        {
            try
            {
                if (currentid<=0)
                {
                    throw new Exception("Gönderilen id değeri sıfırdan büyük olmadılır.");
                }
                ...
                //eğer newsurname parametresi dolu ise isim güncellenecek
                ...
                if (updateResult>0)
                {
                    return "Kayıt başarılı bir şekilde güncellenmiştir.";
                }
                else
                {
                    throw new Exception("Beklenmedik bir hata nedeniyle kayıt güncelleme başarısızdır.");
                }
