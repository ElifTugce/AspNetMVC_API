...
namespace AspNetMVC_API.Controllers
{
    ...
    public class StudentController : ApiController
    {
        ...
        public ResponseData Insert([FromBody] StudentViewModel model)
        {
            try
            {
                if (model==null) //modelde herhangi bir data yoksa
                {
                    return new ResponseData()
                    {
                        Success = false,
                        Message = "Ekleme işlemi yapabilmemiz için verilerinizi düzgün göndermeniz gerekmektedir."
                    };
                }
        ...
        public ResponseData Update([FromBody] StudentViewModel model)
        {
            try
            {
                ...
                {
                    throw new Exception("Öğrenci güncelleme işlemi beklenmedik bir hata ile karşılaştı.");
                }
            }
            catch (Exception ex)
            {
        ...
        public ResponseData Delete(int id)
        {
            try
            {
                ...
                if (student==null)
                {
                    throw new Exception("Gönderilen id'ye ait öğrenci bulunamadı. Silme işlmei başarısız.");
                }
